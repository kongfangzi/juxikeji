...
//
       // setHeader("X-APIKey","eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJwYXlsb2FkIjoie1widXNlck5hbWVcIjpcImFkbWluXCIsXCJ1c2VySWRcIjoxLFwiY3JlYXRUaW1lXCI6MTU3NTM1MjM4MDcyNCxcImV4cGlyZXNcIjoxNTc1NDM4NzgwNzI0LFwidG90YWxSb2xlc1wiOm51bGwsXCJjdXJyZW50Um9sZVwiOlsxXSxcImN1cnJlbnRNZXJjaGFudFwiOjF9In0.ZVCPjC7iWZIx8dQ-RZLTzBLNGWbdYRC5nNQLr2FipcQ");

        JSONObject params = new JSONObject();
        //params.put("password","1befa80454e2e67ff2e149ac21802bba");
        //params.put("username","admin");
        //params.put("X-APIKey","eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJwYXlsb2FkIjoie1widXNlck5hbWVcIjpcImFkbWluXCIsXCJ1c2VySWRcIjoxLFwiY3JlYXRUaW1lXCI6MTU3NTM1MjM4MDcyNCxcImV4cGlyZXNcIjoxNTc1NDM4NzgwNzI0LFwidG90YWxSb2xlc1wiOm51bGwsXCJjdXJyZW50Um9sZVwiOlsxXSxcImN1cnJlbnRNZXJjaGFudFwiOjF9In0.ZVCPjC7iWZIx8dQ-RZLTzBLNGWbdYRC5nNQLr2FipcQ");
        params.put("pageNo","1");
        params.put("pageSize","10");
        HttpUtil httpUtil = HttpUtil.init();
        httpUtil.setHeader("X-APIKey","eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJwYXlsb2FkIjoie1widXNlck5hbWVcIjpcImFkbWluXCIsXCJ1c2VySWRcIjoxLFwiY3JlYXRUaW1lXCI6MTU3NTM1MjM4MDcyNCxcImV4cGlyZXNcIjoxNTc1NDM4NzgwNzI0LFwidG90YWxSb2xlc1wiOm51bGwsXCJjdXJyZW50Um9sZVwiOlsxXSxcImN1cnJlbnRNZXJjaGFudFwiOjF9In0.ZVCPjC7iWZIx8dQ-RZLTzBLNGWbdYRC5nNQLr2FipcQ");

        httpUtil.setParam("param",params.toJSONString());
        //String URL ="http://118.31.178.133:8082/awapis/openapi/login";   //登录接口
        String URL ="http://118.31.178.133:8082/awapis/product/get/page";
        Map<String, String> post = httpUtil.post(URL);
        System.out.println(post.get("result"));
    }
}
