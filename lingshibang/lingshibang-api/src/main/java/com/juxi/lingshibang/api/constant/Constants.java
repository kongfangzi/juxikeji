 ...
 * under the License.
 */
package com.juxi.lingshibang.api.constant;
...
public class Constants {
    ...
    public enum GENDER_ENUME{
        male((short) 0),female((short)1),unknown((short)2),NULL((short)2);
        GENDER_ENUME(Short value) {
            this.value = value;
        }
    ...
    public enum SMILE_ENUME{
        yes((short) 1);
        SMILE_ENUME(Short value) {
            this.value = value;
        }
        private final Short value;
