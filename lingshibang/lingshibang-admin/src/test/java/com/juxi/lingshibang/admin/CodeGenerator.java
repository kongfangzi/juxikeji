...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = "E:/lingshibang/lingshibang-admin";
...
//        ,"sys_role_menu","sys_role_permission","sys_role_user");
        strategy.setInclude("tb_appraise","tb_category","tb_category_group","tb_chat_message","tb_chat_message_backup","tb_cps_order_info"
